          ...
          <div className="col-lg-6 m-15px-tb">
            <div className="about-info">
              ...
              <div className="about-text">
                <h3>
                 Pedometer IOS Native App for tracking steps
                </h3>
                <p>
                ...
                <div className="btn-bar">
                  <a className="px-btn px-btn-theme" href="https://www.apple.com/app-store/">
                    <span>Open on IOS AppStore</span>
                  </a>
                  <a className="px-btn px-btn-theme" href="#">
                    <span>App Demo <i className="fa-computer"/> </span>
                  </a>
                </div>
              </div>
            </div>
